...
class CourseRVAdapter(
    ...
    override fun onBindViewHolder(holder: CourseRVAdapter.CourseViewHolder, position: Int) {
        ...
        val detailOB =  courseList[position]
        ...
        holder.coursecount.text = courseList.get(position).stateCount

        holder.itemView.setOnClickListener{
            onItemClick?.invoke(detailOB)
        }
    }
    ...
    class CourseViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val coursecount : TextView = itemView.findViewById(R.id.stateCount)
    }
}